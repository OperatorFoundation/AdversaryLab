...
//class TLS12CoreML
//{
//    func isTls12(labData: LabData, forConnection connection: ObservedConnection) -> Bool
//    {
//        var outData: Data?
//        var inData: Data?
//        
...
//        }
//        
//        guard let outPacket = outData else {
//            NSLog("Error, connection has no outgoing packet")
//            return false
//        }
//        
//        guard let inPacket = inData else {
...
//    }
//    
//    func processTls12(labData: LabData, connection: ObservedConnection) -> String?
//    {
